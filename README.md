This is because nested code fences inside a code block break into multiple blocks.

Here is the exact text without outer code fences, so you can highlight all of it and copy it as one single block:
